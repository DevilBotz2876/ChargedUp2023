 ...
 * @author ParkerMeyers
 */
public class SlowRotateDriveCommand extends CommandBase {
  ...
  public void execute() {
    ...
    */
    ...
    final var calculatedRot =
        -(rot
            * Robot.getSysIdConstant("MAX_ANGULAR_SPEED").asDouble()
            / Constants.DriveConstants.PRECISION_ROTATE_SPEED_DIVIDER);
